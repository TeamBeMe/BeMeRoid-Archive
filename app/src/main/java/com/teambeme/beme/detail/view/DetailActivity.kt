...
class DetailActivity : BindingActivity<ActivityDetailBinding>(R.layout.activity_detail) {
    ...
    private fun dotClickListener() {
        binding.txtDetailDot.setOnClickListener {
            ...
            bottomSheetFragment = if (detailViewModel.detailData.value!!.isAuthor) {
                BottomMyReplyFragment.newInstance(true)
            } else {
                BottomOtherReplyFragment()
            }
    ...
    private fun positionListener() {
        var bottomSheetFragment = BottomSheetDialogFragment()
        bottomSheetFragment = when (detailViewModel.authority) {
            MY_REPLY -> BottomMyReplyFragment.newInstance(false)
            MY_OTHER_REPLY -> BottomMyOtherReplyFragment()
            else -> BottomOtherReplyFragment()
        }
        bottomSheetFragment.show(
            supportFragmentManager,
            bottomSheetFragment.tag
