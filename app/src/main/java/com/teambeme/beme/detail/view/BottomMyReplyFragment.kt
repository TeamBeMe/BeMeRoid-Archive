...
@AndroidEntryPoint
class BottomMyReplyFragment : BottomSheetDialogFragment() {
    private lateinit var binding: ItemBottomMyBinding
    private val detailViewModel: DetailViewModel by activityViewModels()
    private val child by lazy { arguments?.getBoolean("child") ?: false }
    ...
    companion object {
        fun newInstance(child: Boolean) = BottomMyReplyFragment().apply {
            arguments = Bundle().apply { putBoolean("child", child) }
        }
    }
}
